...
public class BlockSoyBean extends BlockCrop
{
                                    ...
                                    EntityPlayer player, int side, float posX, float posY, float posZ)
    {
        if (world.getBlockMetadata(x, y, z) == 7)
        {
            ...
            EntityItem entityItemCrop = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, new ItemStack(ModItems.soyBean, 1));
            EntityItem entityItemSeed = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, new ItemStack(ModItems.soyBeanSeed, 1));
