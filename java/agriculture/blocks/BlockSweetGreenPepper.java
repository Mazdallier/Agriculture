...
public class BlockSweetGreenPepper extends BlockCrop
{
    private IIcon[] iconArray;

    public BlockSweetGreenPepper(String name)
    {
        super();
        setHardness(0.0f);
        setBlockName(name);
    ...
    {
        return ModItems.sweetGreenPepperSeed;
    }

    @Override
    protected Item func_149865_P()
    {
        return ModItems.sweetGreenPepper;
    }
}
