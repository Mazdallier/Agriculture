...
public class BlockChineseCabbage extends BlockCrop
{
    private IIcon[] iconArray;

    public BlockChineseCabbage(String name)
    {
        super();
        setHardness(0.0f);
        setBlockName(name);
    ...
    {
        return ModItems.chineseCabbageSeed;
    }

    @Override
    protected Item func_149865_P(){
        return ModItems.chineseCabbage;
    }
